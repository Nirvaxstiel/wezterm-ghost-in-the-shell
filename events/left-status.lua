...
cells
    :add_segment(1, GLYPH_SEMI_CIRCLE_LEFT, left_colors.scircle, attr(attr.intensity('Bold')))
    :add_segment(2, ' ', left_colors.default, attr(attr.intensity('Bold')))
    :add_segment(3, ' ', left_colors.default, attr(attr.intensity('Bold')))
    :add_segment(4, GLYPH_SEMI_CIRCLE_RIGHT, left_colors.scircle, attr(attr.intensity('Bold')))
